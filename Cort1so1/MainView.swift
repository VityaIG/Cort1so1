...
struct MainView: View {
    ...
    @AppStorage("lastJailbreakMethod") private var lastJailbreakMethod: String = ""
        ...
        NavigationView {
            ...
            .fullScreenCover(isPresented: $showingProcessModal) {
                DopamineProcessView(method: selectedMethod, onComplete: {
                    ...
                    isJailbroken = true
                    lastJailbreakMethod = selectedMethod.rawValue
                    UserDefaults.standard.set(selectedMethod.rawValue, forKey: "lastJailbreakMethod")
