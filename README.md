...
<p align="center">
  <b>Универсальная системная утилита, менеджер твиков Substrate и симулятор джейлбрейка / отката iOS в нативном стиле Apple HIG</b>
</p>
...
**Cort1so1** — нативное iOS-приложение, сочетающее в себе интерактивную симуляцию джейлбрейка в стилистике Dopamine v2, динамический модуль управления системными твиками **Substrate Tweak Engine** (появляется только после активации джейлбрейка) и высокоточный движок симуляции отката прошивок iOS.
...
- **Каталог IPSW прошивок**: актуальные версии iOS 26.6, iOS 26.0, iOS 18.7.1 и iOS 18.5 с отображением статуса подписи Apple (TSS Signed / SHSH2 blobs).
...
- **5 детализированных этапов восстановления**:
  1. `0s – 10s`: **TSS & ApTicket** (запрос gs.apple.com и валидация ApTicket).
